...
const API_KEY = process.env.ANTROPIC_API_KEY
const MAX_TOKENS = 8192
const TEMPERATURE = 1.0

// Used for high complexity tasks, like code generation
const HIGH_MODEL = "claude-opus-4-20250514"
// Used for mid complexity tasks, like reading features and deciding what to do next
const MID_MODEL = "claude-sonnet-4-20250514"
// Used for low complexity tasks, like summarizing conversations
const LOW_MODEL = "claude-3-5-haiku-latest"
